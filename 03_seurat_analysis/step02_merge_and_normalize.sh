...
mkdir -p /gladstone/bioinformatics/adnetworksppg/Project_1/NK01/results/snRNA_mm10/analysis_hapoe_chr/05_seurat_analysis_filter_percent_mt_noGFAPCre/data/02_merge_and_normalize/
mkdir -p /gladstone/bioinformatics/adnetworksppg/Project_1/NK01/results/snRNA_mm10/analysis_hapoe_chr/05_seurat_analysis_filter_percent_mt_noGFAPCre/plot/02_merge_and_normalize/
...
singularity exec $container_dir/r_sn_rna_seq.sif Rscript $script_dir/seurat_analysis_noGFAPCre/src/02_merge_and_normalize.R
